...
const Navbar = () => {
  ...
  return (
    <nav className='fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-[8] bg-[#24120c] bg-opacity-100'>
        <div className='flex container lg:py-4 flex-wrap items-center justify-center mx-auto px-4 py-2'>
            ...
            */}
            ...
            <div className='menu hidden md:block md:w-auto' id='navbar'>
                <ul className='flex p-4 md:p-0 md:flex-row md:space-x-8 my-8'>
